...
describe("Integration", function () {
    ...
    it("should inline an image", function (done) {
        var doc = testFixture(
            '<img src="' + fixturePath("fakeImage.png") + '">'
        );
    ...
    it("should inline an image input", function (done) {
        var doc = testFixture(
            '<input type="image" src="' + fixturePath("fakeImage.png") + '">'
        );
    ...
    it("should inline a font-face rule", function (done) {
        var doc = testFixture(
            "<style>" +
                ...
                'url("' +
                fixturePath("fakeFont.woff") +
                '"), ' +
                'url("' +
                fixturePath("fakeFont.ttf") +
                '") format("truetype"); }' +
                "</style>"
        );
    ...
    it("should inline a script", function (done) {
        var doc = testFixture(
            '<script src="' + fixturePath("aScript.js") + '">'
        );
